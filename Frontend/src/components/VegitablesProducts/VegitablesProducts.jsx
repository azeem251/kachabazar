...
const VegitablesProducts = () => {
    ...
    // ✅ Only Fruits & Vegetables → Fruits OR Vegetables
    let filteredProducts = products.filter(
        (product) =>
            product.category === 'Fruits & Vegetables' &&
            (product.subcategory === 'Fruits' || product.subcategory === 'Vegetables')
    );
        ...
        <div className='vegitables_wrapper py-5 bg-gray-50 my-4'>
            <div className='container mx-auto px-4'>
                <div className='top-heading text-center'>
                    <h2 className='mb-2 text-2xl font-semibold'>Popular Products for Daily Shopping</h2>
                                ...
                                <div key={product._id}  className='group box-border overflow-hidden flex rounded-md shadow-sm p-0 flex-col items-center bg-white relative'>
                                    ...
                                    <div className='w-full px-3 lg:px-4 pb-4 overflow-hidden'>
                                        <div className='relative mb-1'>
                                            <h6 className='truncate mb-0 block  font-medium text-gray-500'>
...
export default VegitablesProducts;
